...
function getKey(event)
{
    ...
    var test = hasCollided(square1,square2, sqaure3);
    var test3 = false;
    for(var i = 0; i < squareArray.length; i++)
    {

        test3 = hasCollided(square1,squareArray[i]);
        if(test3 == true)
        {
            break;
        }
...
function drawSquare()
{
    ...
    ctx.fillStyle = sqaure3.mainColor;
    ctx.fillRect(sqaure3.x, sqaure3.y, sqaure3.width, sqaure3.height);
    for(var i = 0; i < squareArray.length; i++)
    {
